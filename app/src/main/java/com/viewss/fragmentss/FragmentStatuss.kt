...
import com.utilss.getFolderPermissions
...
class FragmentStatuss : Fragment() {
                ...
                when(type){
                    Constants.TYPE_WHATSAPP_MAIN->{
                        ...
                        permissionLayout.btnPermission.setOnClickListener {
                            getFolderPermissions(context= requireContext(), REQUEST_CODE = WHATSAPP_REQUEST_CODE,
                    ...
                    Constants.TYPE_WHATSAPP_BUSINESS->{
                        ...
                        permissionLayout.btnPermission.setOnClickListener {
                            getFolderPermissions(context= requireContext(), REQUEST_CODE = WHATSAPP_BUSINESS_REQUEST_CODE,
    ...
    fun refreshStatuses() {
        when (type) {
            Constants.TYPE_WHATSAPP_MAIN -> {
                makeText(requireActivity(), "Refreshing WP Statuses", LENGTH_SHORT).show()
                getWhatsAppStatuses()
            }
                ...
                makeText(
                    requireActivity(),
                    "Refreshing WP Business Statuses", LENGTH_SHORT).show()
                getWhatsAppBusinessStatuses()
            }
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode== AppCompatActivity.RESULT_OK){
            ...
            if (resultCode == WHATSAPP_REQUEST_CODE){
